...
namespace UGUIExtension
{
    public class ReuseItem : MonoBehaviour
    {
        ...
        private Action<int, GameObject> m_RefreshCallback;
        ...
        public Action<int, GameObject> RefreshCallback { get => m_RefreshCallback; set => m_RefreshCallback = value; }
        ...
        //Vector2 itemSize, 
        public void Refresh(int index, bool callback = true)
        {
            Index = index;
            ...
            {
                m_RefreshCallback(index, this.gameObject);
